#code written by Kunal,Mamta and Muktanshi
...
#chilanka
Label(sroot,text="Mukum Hotel",font='Timesnewroman 40 ',bg='blue',fg='white').place(x=535,y=10)
Label(sroot,text="Made by -",font='Timesnewroman 40 ',bg='white',fg='black').place(x=535,y=90)
Label(sroot,text="Kunal,Mamta and Muktanshi",font='Aerial 20 ',bg='yellow',fg='red').place(x=535,y=180)
Label(sroot,text=":)",font='Timesnewroman 20',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	root.title("MADE BY Kunal , Mamta and Muktanshi")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	top_frame = Frame(root,height=70,width=1080,bg='red')
	...
	tf_label = Label(top_frame,text='Mukum Hotel',font='algerian 40',fg='black',bg='red',height=70)
	...
	def hotel_status():
		global b_frame
		b_frame = Frame(root,height=400,width=1080,bg='red')
	...
	#------------inner frames of bottom frame-------------------------
		...
		smf1 = Frame(b_frame,height=150,width=175,bg='red')
		...
		smf2 = Frame(b_frame,height=150,width=175,bg='red')
		...
		smf3 = Frame(b_frame,height=150,width=175,bg='red')
		...
		smf4 = Frame(b_frame,height=150,width=175,bg='red')
		...
		smf5 = Frame(b_frame,height=150,width=175,bg='red')
		...
		smf6 = Frame(b_frame,height=150,width=175,bg='red')
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Kunal,Mamta and Muktanshi',fg='black',bg='gray91',font='msserif 8')
		nl.place(x=750,y=310)
		nl.tkraise()
	...
	def staff():
		...
		emp1.pack()
		emp1f.place(x=0,y=0)
		emp1inf = Frame(b_frame,bg='red',height=122,width=300)
		Label(emp1inf,text="Manager",bg='white',font='msserif 17 bold').place(x=60,y=0)
		Label(emp1inf,text="Mr. Kunal Gupta",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : guptakunal504@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		...
		emp1inf = Frame(b_frame,bg='red',height=116,width=310)
		Label(emp1inf,text="Customer Executive",bg='white',font='msserif 17 bold').place(x=45,y=0)#pack(side='top')
		Label(emp1inf,text="Ms. Muktanshi Sharma",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Extention : 032",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : muktanshisharma@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)	
		emp1inf.pack_propagate(False)
		...
		emp1inf = Frame(b_frame,bg='red',height=121,width=320)
		Label(emp1inf,text="Event Organizer",bg='white',font='msserif 17 bold').place(x=72,y=0)#pack(side='top')
		Label(emp1inf,text="Ms. Mamta Yadav (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(emp1inf,text="Extention : 028",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(emp1inf,text="Mail : mamtakumariyadav53@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)	
		emp1inf.pack_propagate(False)
		...
		Frame(b_frame,height=13,width=250,bg='red').place(x=410,y=2)
		Frame(b_frame,height=13,width=250,bg='red').place(x=410,y=153)
	...
	def rooms():
		...
		def roomdet(rno):
			...
			rdata=cur.fetchall()
			#print (rdata)
			smf1 = Frame(b_frame,height=120,width=145,bg='red')
			hline = Frame(b_frame,height=10,width=960,bg='red')
			hline.place(x=122,y=27)
			vline = Frame(b_frame,height=400,width=7,bg='red')
			...
			smf2 = Frame(b_frame,height=120,width=145,bg='red')
	...
	def reserve():
		b_frame = Frame(root,height=420,width=1080,bg='red')
		path = "images/newbg6lf.jpg"
		img = ImageTk.PhotoImage(Image.open(path))
